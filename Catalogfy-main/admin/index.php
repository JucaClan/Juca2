    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center mt-3">
            <div class="col-4 conteudo">
                <form id="formLogin"  action="actions/classes/cadastrar_contato.php" method="post">
                    <div class="mb-3">
                    ...
                    <div class="form-group">
                        <button type="submit" id="btnEntrar" href="" class="form-control btn btn-primary rounded submit px-3">Entrar</button>
                    </div>
                    <div class="mb-3 mt-3">
