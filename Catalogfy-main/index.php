    ...
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col-3">
                ...
                <div class="card">
                    <a href="#"><img class="card-img-top" src="admin/fotos/<?= $prod['foto']; ?>" width="150px" alt="<?= $prod['nome'];?>" alt="Imagem"></a>
                    <div class="card-body">
                        <h4 class="card-title"><?= $prod['nome'];?></h4>
                        <p class="card-text"><?= substr($prod['descricao'],0,20)."...";?>
                        <div class="d-grid gap-2">
                            <a href="produto.php?id=<?=$prod['id'];?>" class="btn btn-primary">Mais detalhes</a>
                        </div>
                        </p>
                    </div>
                </div>
